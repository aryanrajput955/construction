	...
	return (
		<section className='relative min-h-screen flex items-center justify-center bg-black overflow-hidden'>
			...
			<motion.div
				...
				<motion.h1
					variants={item}
					className='text-5xl md:text-6xl lg:text-7xl leading-tight hero_heading_font'>
				...
				<motion.div
					...
					<motion.button
						...
						whileTap={{scale: 0.98}}
						className='cursor-pointer inline-flex items-center justify-center gap-3 bg-[#e55a24] hover:bg-[#d14d1f] btn-always-white font-bold px-10 py-5 text-lg transition-all duration-300 shadow-2xl'>
						<svg
							className='w-6 h-6'
							fill='none'
							stroke='currentColor'
					...
					<motion.button
						...
						className='inline-flex items-center justify-center gap-3 border-2 border-white font-bold px-10 py-5 text-lg cursor-pointer shadow-2xl phone-btn'>
						<svg
							className='w-6 h-6'
							fill='none'
							stroke='currentColor'

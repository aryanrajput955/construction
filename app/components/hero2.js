      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="cursor-pointer inline-flex items-center justify-center gap-3 bg-[#e55a24] hover:bg-[#d14d1f] text-white font-bold px-10 py-5 text-lg transition-all duration-300 shadow-2xl"
          >
          ...
          <motion.button
            ...
            className="inline-flex items-center justify-center gap-3 border-2 border-white text-white font-bold px-10 py-5 text-lg cursor-pointer transition-all duration-300"
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
          ...
          {[
            ...
            <motion.div
              ...
              variants={{
                ...
                show: { opacity: 1, y: 0, transition: { delay: index * 0.1 + 0.5 } },
              }}

...
import { Building2, Hammer, Ruler, Award, Clock, Shield, Users, Star } from "lucide-react"
...
function StatCard({ stat, index }) {
  ...
  return (
    ...
    >
      ...
      <h4 className="mb-2 text-4xl font-bold text-card-foreground">{stat.number}</h4>
...
export default function AboutPage() {
  ...
  const testimonials = [
    {
      quote: "FRONT RIDGE transformed our office space beyond our expectations. Their attention to detail and commitment to quality is unmatched.",
      name: "Sarah Mitchell",
      role: "CEO, TechVision Inc",
      initials: "SM"
    },
    {
      quote: "Professional, reliable, and incredibly skilled. They completed our restaurant renovation ahead of schedule with stunning results.",
      name: "Michael Chen",
      role: "Owner, The Golden Spoon",
      initials: "MC"
    },
    {
      quote: "From design to execution, FRONT RIDGE handled our retail space buildout flawlessly. Highly recommend their services!",
      name: "Emily Rodriguez",
      role: "Director, Luxe Boutique",
      initials: "ER"
    },
    {
      quote: "Their team's expertise in commercial construction is evident in every project. Our new headquarters looks absolutely incredible.",
      name: "David Thompson",
      role: "CFO, Global Solutions",
      initials: "DT"
    },
    {
      quote: "FRONT RIDGE delivered exceptional craftsmanship on our medical facility. They understood our unique requirements perfectly.",
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl font-bold text-foreground mb-6 md:text-5xl">
                Welcome to <span className="text-accent">FRONT RIDGE</span> Constructions
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                At FRONT RIDGE Constructions, we specialize in transforming indoor spaces into functional masterpieces. Our expertise spans commercial interiors, office fit-outs, retail environments, hospitality venues, and specialized facilities. We understand that every square foot matters, and we're committed to maximizing both aesthetics and functionality.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                From concept to completion, our dedicated team of designers, engineers, and craftsmen work collaboratively to bring your vision to life. We pride ourselves on delivering projects on time, within budget, and exceeding expectations. Our comprehensive approach includes space planning, interior architecture, custom millwork, and complete construction management—ensuring a seamless experience from start to finish.
              </p>
            </motion.div>
      ...
      <section className="py-24 bg-background overflow-hidden">
        <div className="mx-auto max-w-7xl mb-16 px-4">
          ...
          >
            ...
            <p className="mx-auto max-w-3xl text-lg text-muted-foreground">
              Don't just take our word for it—hear from the clients who've experienced the FRONT RIDGE difference.
            </p>
          </motion.div>
        </div>
        ...
        <div className="relative">
          <div className="flex overflow-hidden">
            <div className="flex animate-scroll" style={{ transform: `translateX(${scrollPosition}px)` }}>
      ...
      <section className="relative py-32 px-4 overflow-hidden bg-gradient-to-br from-card via-background to-card">
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-0 right-1/4 h-96 w-96 rounded-full bg-accent blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          >
            ...
            <p className="mb-12 text-xl leading-relaxed text-muted-foreground max-w-2xl mx-auto">
              Ready to transform your space? Our team is standing by to discuss your project and bring your vision to life with unparalleled expertise and dedication.
            </p>
